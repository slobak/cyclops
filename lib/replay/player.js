...
Player.prototype._doEvent = function(e) {
  ...
  console.log("Cyclops player: playing event", e);
  ...
  // TODO: figure out how to simulate scrolling, since we can't synthesize
  // wheel events.  :(
...
Player.prototype._playNextEvent = function() {
  ...
  var e = me._nextEvent();
  if (e === null) {
    console.log("Cyclops player: no more events, stopping playback");
    return webdriver.promise.resolved();
  }
